...
<div class="container">
  <div class="main-container">
    ...
    <form action="servicio.php" id="formReporte" method="post" enctype="multipart/form-data" class="mb-4">
      ...
      <div class="mb-3">
        <textarea class="form-control" name="trabajos" rows="4" 
                  placeholder="Describa los trabajos realizados durante el servicio técnico..."></textarea>
      </div>
