...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $nombre_supervisor = $_POST['nombre_supervisor'] ?? null;
    ...
    if($confirmado === 'si'){
        ...
        header("Location: guardar_reporte_rooftop.php?id=$mantenimiento_id");
    }
    exit;
}
...
<table border="1" cellspacing="0" cellpadding="4" width="100%" style="border-collapse: collapse; font-family: Arial, sans-serif; font-size: 12px;">
  <tr>
    ...
    <td width="60%" align="center" style="font-weight: bold; font-size: 13px;">
      ...
      CHECK LIST DE MANTENIMIENTO PREVENTIVO DE EQUIPOS – ROOFTOP <br>
  ...
  <form action="rooftop.php"  id="formReporte" method="post" enctype="multipart/form-data" class="mb-5">
...
<div class="table-responsive mb-3">
  <table class="table table-bordered table-sm text-center align-middle">
    ...
    <tbody>
      <?php
      $actividades = [
        "Verificar operación compresor arranque y parada",
"Inspección presiones de succión y descarga",
"Lavado de serpentín y componentes con presión de agua",
"Lubricación de componentes de transmisión",
"Verificación de faja, modelo y tensado",
"Verificar parámetros eléctricos de compresores, limpieza y ajuste de componentes",
"Verificar estado de bandeja pintar si lo requiere",
"Limpieza de drenaje",
