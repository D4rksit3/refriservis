    ...
    <?php foreach($rows as $r): ?>
      <div class="card shadow-sm mb-3">
        <div class="card-body">
          ...
          <p class="card-text mb-1"><b>Cliente:</b> <?= htmlspecialchars($r['cliente']) ?> (<?= htmlspecialchars($r['direccion']) ?>)</p>
          ...
          <p class="card-text mb-2">
            ...
            <?php elseif ($r['estado'] === 'en progreso'): ?>
          ...
          <div class="d-flex gap-2">
            <a href="/mantenimientos/editar.php?id=<?= $r['id'] ?>" class="btn btn-primary btn-sm flex-fill">✏️ Actualizar</a>
